...
/**
 * Caching implementation of DrugDetailsServiceApi.
 *
 * - author: TCCODER
 * - version: 1.0
 */
class CachingFDAServiceApi: FDAServiceApi {

    /// singleton
    static let sharedWrapper: DrugDetailsServiceApi = CachingFDAServiceApi(baseUrl: Configuration.shared.ndbApiBaseUrl)
